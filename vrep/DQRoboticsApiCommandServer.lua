...
--      reference frames.
--    - Removed unnused inputs inFloats, inStrings, and inBuffer from functions get_mass(),
--      get_center_of_mass(), and get_inertia(). Also renamed some of their variables and
--      added comments to make them clearer.
...
function get_center_of_mass(inInts)
    if #inInts==1 then
...
----------------------------------------------------------------------------------
--/**
-- * @brief Returns the mass an object.
